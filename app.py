...
if current_sidebar_option == SIDEBAR_SEARCH :
    ...
    for record in data:
        ...
        with sidebar.expander(f"{record['nazwa']}", expanded=is_expanded):
            ...
            st.button("Zapisz mnie pls!!!!", type="primary", key=record['id'],  on_click=change_view_and_set_chosen_voluteering, args=(CHOSEN_VOLUNTEERING_VARIABLE ,record['id'],CURRENT_VIEW_VARIABLE, ADD_ME))
    ...
    for record in filtered_data:
      ...
      with sidebar.expander(f"{record['nazwa']} | score: {record['wynik']}", expanded=is_expanded):
          ...
          st.button("Zapisz mnie pls!!1!!", type="primary", key=record['id'],  on_click=change_view_and_set_chosen_voluteering, args=(CHOSEN_VOLUNTEERING_VARIABLE ,record['id'],CURRENT_VIEW_VARIABLE, ADD_ME))
